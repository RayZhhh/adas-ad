...
class FunSearchProxyTensorboardProxyProfiler(TensorboardProfiler, FunSearchProxyProfiler):
    _prog_db_order = 0
...
class FunSearchProxyWandbProxyProfiler(WandBProfiler, FunSearchProxyProfiler):
    _prog_db_order = 0
